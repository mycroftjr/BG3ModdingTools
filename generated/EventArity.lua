local EventArity = {
	...
	PuzzleUIClosed = 3,
	PuzzleUIUsed = 5,
	QuestAcceptReverted = 2,
	QuestAccepted = 2,
	QuestCloseReverted = 1,
	QuestClosed = 1,
	QuestUpdateUnlockReverted = 3,
	...
	StoppedSneaking = 1,
	SubQuestUpdateUnlockReverted = 3,
